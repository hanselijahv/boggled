...
public class _BoggledStub extends org.omg.CORBA.portable.ObjectImpl implements Boggled
{

  public void login (String username, String password) throws UserNotFoundException, BoggledApp.AlreadyLoggedInException
  {
            ...
            try {
                ...
                if (_id.equals ("IDL:BoggledApp/UserNotFoundException:1.0"))
                    throw UserNotFoundExceptionHelper.read ($in);
  ...
  public String getWaitingTime (Callback objRef)
  {
            ...
            try {
                ...
                CallbackHelper.write ($out, objRef);
                $in = _invoke ($out);
