package net.team6.boggled.user.client.game;

import net.team6.boggled.user.client.state.entry.EntryState;
import net.team6.boggled.common.core.Size;
import net.team6.boggled.user.client.display.Display;
...
public class Game implements Runnable{
    ...
    public Game(int width, int height) throws IOException, FontFormatException {
        ...
        state = new PlayState(new Size(width, height), input, gameSettings);
