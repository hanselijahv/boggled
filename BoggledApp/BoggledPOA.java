 ...
 implements BoggledApp.BoggledOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("roundWinner", new java.lang.Integer (11));
    _methods.put ("roundPoints", new java.lang.Integer (12));
    _methods.put ("playerPoints", new java.lang.Integer (13));
    _methods.put ("isGameFinished", new java.lang.Integer (14));
    _methods.put ("gameScore", new java.lang.Integer (15));
    _methods.put ("currentRound", new java.lang.Integer (16));
    _methods.put ("getLeaderboard", new java.lang.Integer (17));
  }
